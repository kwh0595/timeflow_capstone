        ...
        if (ChatMessage.MessageType.ENTER.equals(message.getType())) {
            ...
            try {
                ...
                if (message.getMessage().startsWith("#")) {
                    ChatBotResponse botResponse = chatBotService.sendMessage(teamId, message.getMessage());
                    ...
                    ChatEntity chat = chatService.createChat(teamId, botMessage.getSender(), botMessage.getMessage());
